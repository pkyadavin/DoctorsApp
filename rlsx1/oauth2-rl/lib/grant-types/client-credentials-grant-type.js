...
ClientCredentialsGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    .then(function() {
      return this.getUserFromClient(client, request);
    })
    .then(function(user) {
...
ClientCredentialsGrantType.prototype.getUserFromClient = function(client, request) {
  return promisify(this.model.getUserFromClient, 2).call(this.model, client, request)
    .then(function(user) {
      if (!user) {
...
ClientCredentialsGrantType.prototype.saveToken = function(user, client, scope, request) {
  var fns = [
