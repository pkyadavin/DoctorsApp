...
declare var $: any;
@Component({
  selector: 'app-conqueue',
  templateUrl: './conqueue.component.html',
  styleUrls: ['./conqueue.component.css']
})

export class ConqueueComponent extends Property implements OnInit, OnDestroy{
  ...
  constructor(private _util: Util,
    ...
    private _returnService: ConsumerReturnsService,
  ...
  getOrderDetailOnRowClick(RMANumber, status) {
    ...
    this._router.navigate([
      "back-office/con_returns/conqueue/" +
