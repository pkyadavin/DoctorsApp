...
export class Color extends Property {
    ...
    CurrentColorObj: ColorModel = new ColorModel();
    constructor(
        private _util: Util, private _menu: SidebarService, private _router: Router,
        private colorService: ColorService, public commonService: CommonService, 
    ...
    setDataSource() {
        ...
        this.dataSource = {
            ...
            getRows: (params: any) => {
                ...
                this.colorService.loadAll(params.startRow, params.endRow, sortColID, sortDirection, this.filterText, this.partnerID).
                    subscribe(
                        result => {
                            debugger;
                            ...
                            //debugger;
                            var coldef = this.h_localize.find(element => element.field == "ColorName");
    ...
    onSelectionChanged() {
        ...
        this.CurrentColorObj = this.gridapi.getSelectedRows()[0];
    ...
    onAddCountry() {
        this.ListView = false;
        //this.IsLoaded = true;
        this.CurrentColorObj = new ColorModel();
        if (this.CurrentColorObj.IsActive == undefined) {

            this.CurrentColorObj.IsActive = true;
        }        
    }
    ...
    onEditCountry() {
        ...
        if (this.CurrentColorObj.IsActive.toString() == 'Yes') {
            this.CurrentColorObj.IsActive = true;
        }
        else {
            this.CurrentColorObj.IsActive = false;
        }   
        this.loaderService.display(false);     
    }
    Save(form) {
        ...
        this.CurrentColorObj.UserID = this.UserID
        if (this.CurrentColorObj.ColorID == undefined) {
            this.CurrentColorObj.ColorID = 0;
        }

        //  console.log(JSON.stringify(this.CurrentColorObj));
        this.colorService.Save(this.CurrentColorObj)
    ...
    onDeleteCountry() {
        ...
        //     me.countryService.remove(me.CurrentColorObj.CountryID)
        //         .subscribe(
        //         Result => {
